...
class GlobalFeatureMetric:
    ...
    def stability(self, X, all_importances, epsilon=3,perturber=None, perturber_strategy='mean', dissimilarity='euclidean'):
    ...
    def consistency(self, all_importances_per_model, perturber=None, perturber_strategy='mean', dissimilarity='euclidean'):
            ...
            for model_idx, model_imps in enumerate(all_importances_per_model):
                for compared_model in all_importances_per_model[:model_idx]:
                    ...
                    if dist > largest_dist:
                        largest_dist = dist
            c_values.append(largest_dist) #TODO or var
